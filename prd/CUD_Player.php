        ...
        <div class="row">
            <div class="col-sm-9 center">
                <div class="features_items"><!--features_items-->
                    <h2 class="title text-center">ข้อมูลทีม</h2>
                    <a href="C_Player.php" class="title text-center">เพิ่มข้อมูลนักเตะ</a>
                    <br/>
                    ...
                    <table>
                        <table align="center" border="1" width="80%" class="table table-striped"  id="myTable">
                            ...
                            <?php while($row = mysqli_fetch_assoc($query)) : ?>
                                ...
                                <tr>
                                    <td align="center">&nbsp;&nbsp;<?=$row['TeamName'] ?></td>
                                    <td>&nbsp;&nbsp;<?=$row['PlayerName'] ?></td>
                                    <td align="center">&nbsp;&nbsp;<?=$row['PlayerNumber'] ?></td>
                                    <td align="center">&nbsp;&nbsp;<?=$row['PlayerWeight'] ?></td>
                                    <td align="center">&nbsp;&nbsp;<?=$row['PlayerHeight'] ?></td>
                                    <td align="center">
                                        <a href="edit.php?id=<?=$row['id'] ?>">แก้ไข</a>
                                        <a href="D_Player.php?id=<?=$row['id'] ?>">ลบ</a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        </table>
